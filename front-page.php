				...
				<div class="revolution-slider">
					<ul style="display: none;">
						...
						<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
							<!-- MAIN IMAGE -->
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/image_01.jpg" alt="slidebg1" data-bgfit="cover">
							<!-- LAYERS -->
							<!-- LAYER 01 -->
						...
						<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
							<!-- MAIN IMAGE -->
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/image_02.jpg" alt="slidebg2" data-bgfit="cover">
							<!-- LAYERS -->
							<!-- LAYER 01 -->
						...
						<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
							<!-- MAIN IMAGE -->
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/slider/image_03.jpg" alt="slidebg3" data-bgfit="cover">
							<!-- LAYERS -->
							<!-- LAYER 01 -->
							<div class="tp-caption customin customout"
								data-frames='[{"delay":500,"speed":1200,"from":"y:-40;o:0;","ease":"easeInOutExpo"},{"delay":"wait","speed":500,"to":"o:0;","ease":"easeInOutExpo"}]'
						...
						<div class="announcement clearfix">
							<ul class="columns no-width">
								...
								<li class="column column-1-3">
									<div class="vertical-align">
										<div class="vertical-align-cell">
											<a class="more" href="appointment.html" title="MAKE AN APPOINTMENT"><span>MAKE AN APPOINTMENT</span></a>
										</div>
									</div>
								</li>
							</ul>
					...
					<div class="row full-width gray flex-box page-margin-top-section">
						<div class="column column-1-2 background-1">
							<a class="flex-hide" href="service_engine_diagnostics.html" title="Tiling and Painting">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/960x680/image_01.jpg" alt="">
							</a>
						</div>
							...
							<ul class="services-list clearfix page-margin-top">
								<li>
									<a href="service_engine_diagnostics.html" title="Engine Diagnostics">
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/390x260/image_01.jpg" alt="">
									</a>
								...
								<li>
									<a href="service_lube_oil_filters.html" title="Lube, Oil and Filters">
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/390x260/image_02.jpg" alt="">
									</a>
								...
								<li>
									<a href="service_belts_hoses.html" title="Belts and Hoses">
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/390x260/image_03.jpg" alt="">
									</a>
						...
						<ul class="galleries-list clearfix page-margin-top">
							<li>
								<a href="gallery_tire_change.html" title="Tire Change">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/480x320/image_07.jpg" alt="">
								</a>
							...
							<li>
								<a href="gallery_oil_change.html" title="Oil Change">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/480x320/image_02.jpg" alt="">
								</a>
								<div class="view align-center">
									<div class="vertical-align-table">
										<div class="vertical-align-cell">
							...
							<li>
								<a href="gallery_belts_hoses.html" title="Our Facility">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/480x320/image_08.jpg" alt="">
								</a>
								<div class="view align-center">
									<div class="vertical-align-table">
										<div class="vertical-align-cell">
							...
							<li>
								<a href="gallery_brake_repair.html" title="Brakes Repair">
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/samples/480x320/image_05.jpg" alt="">
								</a>
								<div class="view align-center">
									<div class="vertical-align-table">
										<div class="vertical-align-cell">
						...
						<div class="row">
							<div class="our-clients-list-container page-margin-top">
								<ul class="our-clients-list">
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_01.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_02.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_03.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_04.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_05.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_06.png" alt="">
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/logo_06.png" alt="">
									</li>
