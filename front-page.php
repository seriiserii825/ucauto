...
<div class="full-width main-baner">
            ...
            <div class="col-md-7 col-md-offset-5 col-sm-12">
                <div class="home-contact-form">
                    <div class="home-contact-form-wrap">
                        <h1><?php echo carbon_get_theme_option( 'title' . get_lang() ); ?> <span
                                    class="blue-color"><?php echo carbon_get_theme_option( 'after_title' . get_lang() ); ?></span>
                        </h1>
    ...
    <div class="swiper-container home-baner">
        <div class="swiper-wrapper">
			<?php $main_banner = carbon_get_theme_option( 'crb_main_banner' ); ?>
			<?php foreach ( $main_banner as $item ): ?>
                <div class="swiper-slide">
                    <div class="home-img">
                        <div class="bg-bg"
                             style="background-image:url(<?php echo $item['crb_image']; ?>)">
                        </div>
                    </div>
                </div>
			<?php endforeach; ?>
